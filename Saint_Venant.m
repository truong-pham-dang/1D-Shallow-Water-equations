...
% mise en place
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%/
a=0,b=2; %bornes du domaine
g=9.81;

% maillage en espace
J=400; %nombre de mailles en espace
...
%  plot2d(x,[u(:,1),uFrot(:,1)],[5,6],leg="hauteur@avec frottement");
%  plot2d(x,[u(:,2),uFrot(:,2)],[3,4],leg="vitesse@avec frottement");
%  plot2d(x,u(:,1)+ZB',5,leg="hauteur");
%  plot2d(x,u(:,2),5,leg="vitesse");
%  plot2d(x,[ZB',u(:,1)+ZB'],[3,5],leg="topo@hauteur");
% fin optionnel
...
plot(x,u(:,2))
drawnow
%plot2d(x,[u(:,1)+ZB',u(:,2),Froude],[3,5,7],leg="hauteur@débit@Froude");
%  plot2d(x,[u(:,1)+ZB',uFrot(:,1)+ZB'],[5,6],leg="hauteur@avec frottement");
%  plot2d(x,u(:,1)+ZB',5,leg="hauteur");
%  plot2d(x,u(:,2),5,leg="vitesse");
end
